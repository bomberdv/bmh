		...
		<div class="panel-body">
			<h3 class="btn-block margin-zero" style="line-height: inherit;">
				...
				<small class="btn-block margin-bottom-10 text-muted">
					{{$percentage }}% {{trans('misc.raised')}} {{trans('misc.by')}} {{number_format($response->donations()->where('payment_status', '=', 'paid')->count())}} {{trans_choice('misc.donation_plural',$response->donations()->where('payment_status', '=', 'paid')->count())}}
				</small>
